...
plot(test$DateTime, test$Voltage, type = "l", ylab = "Voltage", xlab="datetime", cex.axis=0.8)
plot(test$DateTime, test$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab="datetime", cex.axis=0.8)
